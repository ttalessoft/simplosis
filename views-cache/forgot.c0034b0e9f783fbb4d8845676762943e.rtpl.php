    ...
    <table class="head-wrap w320 full-width-gmail-android" bgcolor="#f9f8f8" cellpadding="0" cellspacing="0" border="0">
      ...
      <tr class="header-background">
        <td class="header container" align="center">
          <div class="content">
            <span class="brand">
              <a href="http://local.simplosis.com.br/admin">
                SIMPLOSIS - Gerenciador Web
              </a>
            </span>
          </div>
        </td>
                        ...
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              Para alterar sua senha clique no link abaixo <a href="<?php echo htmlspecialchars( $link, ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $link, ENT_COMPAT, 'UTF-8', FALSE ); ?></a>.
                            </td>
                          </tr>
                        </table>
                        <div>
                          ...
                          <tr>
                            <td class="body-signature-cell">
                              ...
                              <p class="body-signature"><img
                                  src="https://www.filepicker.io/api/file/2R9HpqboTPaB4NyF35xt" alt="Company Name"></p>
                            </td>
                          </tr>
                        </table>
                      </td>
      ...
      <tr>
        ...
        <td class="container">
          <div class="content footer-lead">
            <a href="#">Solicite <b>suporte</b></a> se tiver dificuldades em alguma tarefa.
          </div>
        </td>
        <td></td>
      </tr>
