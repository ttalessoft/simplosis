    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-success">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form name="form1" role="form" action="/admin/clifordados/salvar" method="post">
            ...
            <div class="box-body">
              <div class="form-group col-md-12">
                <label>
                  <input type="radio" id="cli_tipo_f" name="tipo_pe" class="tipo_pe" value="f" required>
                  Pessoa física
                </label>
                <label>
                  <input type="radio" id="cli_tipo_j" name="tipo_pe" class="tipo_pe" value="j" required>
                  Pessoa jurídica
                </label>
              </div>
              ...
              <div id="dados">
                ...
                <div id="dados_pf">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="cli_apelido" name="apelido" placeholder="Nome">
                  </div>
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <div class="form-group">
                      <div class="input-group date">
                        ...
                        <input type="text" class="form-control pull-right" id="datepicker2" name="nascimento"
                ...
                <div id="dados_pj">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <div class="form-group">
                      <div class="input-group date">
                        ...
                        <input type="text" class="form-control pull-right" id="datepicker1" name="dt_abertura"
                          placeholder="00/00/0000">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="cli_responsavl" name="responsavel"
                ...
                <div class="form-group col-md-6">
                  <div class="form-group">
                    <label>Grupo</label>
                    <select id="cli_grupo" class="form-control select2" style="width: 100%;" name="grupo" required>
                ...
                <div class="form-group col-md-4">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" data-inputmask="'mask': ['99.999-999', '99.999-999']"
                      data-mask name="cep" placeholder="00.000-000" required>
                    <div class="input-group-addon">
                      <a class="btn-sm" href="#">
                ...
                <div class="form-group col-md-4">
                  <div class="form-group">
                    <label>Cidade</label>
                    <select id="cli_cidade" class="form-control select2" style="width: 100%;" name="cidade" required>
                      <option value="">Selecione..</option>
...
<script>
  ...
  function validarForm() {
    ...
    let d = new Date();
    console.log('clicou: ' + d.getFullYear() + '-' + d.getMonth() + '-' + d.getDate() + ' ' + d.getHours() + ':' + d.getMinutes() + ':' + d.getSeconds() + ' ' + d.getMilliseconds());
    var tipoPessoa;
    var elementos = document.getElementsByName('tipo_pe');
    for (var i = 0; i < elementos.length; i++) {
      if (elementos[i].checked) {
        tipoPessoa = elementos[i].value;
      }
    }
